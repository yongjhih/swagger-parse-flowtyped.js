...
Handlebars.registerPartial('specs', fs.readFileSync(path.join(__dirname, './template/specs.hbs'), 'utf-8'))
Handlebars.registerPartial('spec', fs.readFileSync(path.join(__dirname, './template/spec.hbs'), 'utf-8'))
